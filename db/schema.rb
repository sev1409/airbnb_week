...
ActiveRecord::Schema.define(version: 20171109191047) do
  ...
  create_table "puppies", force: :cascade do |t|
    ...
    t.float    "latitude"
    t.float    "longitude"
    t.index ["user_id"], name: "index_puppies_on_user_id", using: :btree
  end
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["puppy_id"], name: "index_reviews_on_puppy_id", using: :btree
  end
